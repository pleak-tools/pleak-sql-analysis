...
error_noCSGroupSupport = errorTag ++ "Intermediate aggregations and GROUP BY are not supported in combined sensitivity. To use plain derivative sensitivity, remove row costs (e.g. \'G:1.0;\') from norms of all input tables."
