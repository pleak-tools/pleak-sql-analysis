...
performDPAnalysis :: ProgramOptions -> String -> String -> [String] -> [(String,[(String, String)])] -> [(String,[Int],Bool)] -> [String] -> [(String, B.TableExpr, (String,String,String))] -> M.Map String VarState -> IO ()
performDPAnalysis args dataPath initialQuery colNames typeMap taskMap sensitiveVarList tableExprData attMap = do

  let epsilon = getEpsilon args
  let beta    = getBeta args
  (qr,taskAggr) <- BQ.performAnalyses args epsilon beta dataPath initialQuery colNames typeMap taskMap sensitiveVarList tableExprData attMap
...
performPolicyAnalysis :: ProgramOptions -> String -> String -> [String] -> [(String,[(String, String)])] -> [(String,[Int],Bool)] -> [(String, B.TableExpr, (String,String,String))] -> M.Map String (M.Map String VarState, Double) -> M.Map String VarState -> IO ()
performPolicyAnalysis args dataPath initialQuery colNames typeMap taskMap tableExprData plcMapMap attMap = do
  ...
  let step = performPolicyAnalysisStep args dataPath initialQuery colNames typeMap taskMap tableExprData attMap epsilon
...
performPolicyAnalysisStep :: ProgramOptions -> String -> String -> [String] -> [(String,[(String, String)])] -> [(String,[Int],Bool)] -> [(String, B.TableExpr, (String,String,String))] -> M.Map String VarState -> Double -> Maybe Double -> IO Double
performPolicyAnalysisStep args dataPath initialQuery colNames typeMap taskMap tableExprData attMap epsilon beta = do

  (qr,taskAggr) <- BQ.performAnalyses args epsilon beta dataPath initialQuery colNames typeMap taskMap [] tableExprData attMap
